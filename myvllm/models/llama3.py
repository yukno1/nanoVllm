    ...
    def forward(
        ...
        if context.is_prefill and context.cu_seqlens_q is not None:
            ...
            assert context.context_lens is not None, (
                "context_lens must be set for decode mode"
            )
